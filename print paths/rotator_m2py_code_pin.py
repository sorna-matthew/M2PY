...
b = 8           # "Buffer" to allow for R > L case. Also makes room for holding down the element during torsion testing.
s = 4           # Outer support ring thickness
w = 8           # Width of rotator blades
p = 4.78 + 0.45  # Pin width + extrusion thickness at 42 mm/s
...
dz = 0.52 * 0.410   # Layer height based on nozzle diameter, mm
fs = 42             # Frame speed, mm/s
bs = 46             # Beam speed, mm/s
...
p0 = [128, 190, -152]         # for use again below
mp.move(mg, x = p0[0], y = p0[1], z = p0[2]) # Moves to start position of print

mp.wait(mg, seconds = 1) #Gives yourself time to adjust!
